                            ...
                            <dl class="card__item">
                                <dt class="card__img">
                                    <picture>
                                        ...
                                        <img src="<?php echo get_theme_file_uri('./image/camera.gif'); ?>" alt="" width="120px" height="120px">
                                    </picture>
                                </dt><!-- /.card__img -->
                                <dd class="card__text">
                                    <h3>証明写真</h3>
                            ...
                            <dl class="card__item">
                                <dt class="card__img">
                                    <picture>
                                        ...
                                        <img src="<?php echo get_theme_file_uri('./image/contest.gif'); ?>" alt="" width="120px" height="120px">
                                    </picture>
                                </dt><!-- /.card__img -->
                                <dd class="card__text">
                                    <h3>コンテスト</h3>
                            ...
                            <dl class="card__item">
                                <dt class="card__img">
                                    <picture>
                                        ...
                                        <img src="<?php echo get_theme_file_uri('./image/trade.gif'); ?>" alt="" width="120px" height="120px">
                                    </picture>
                                </dt><!-- /.card__img -->
                                <dd class="card__text">
                                    <h3>買取り・下取り</h3>
                            ...
                            <dl class="card__item">
                                <dt class="card__img">
                                    <picture>
                                        ...
                                        <img src="<?php echo get_theme_file_uri('./image/vhs.gif'); ?>" alt="" width="120px" height="120px">
                                    </picture>
                                </dt><!-- /.card__img -->
                                <dd class="card__text">
                                    <h3>ダビング</h3>
